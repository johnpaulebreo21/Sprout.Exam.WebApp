...
export class EmployeeCalculate extends Component {
    ...
    async calculateSalary() {
        ...
        if (isNaN(this.state.absentDays) || isNaN(this.state.workedDays) || this.state.absentDays.toString().trim() == "" || this.state.workedDays.toString().trim() == "") {
            alert("Days should be number");
            return;
        }
